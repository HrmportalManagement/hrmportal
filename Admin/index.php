               ...
               <div class="container">
                  <div class="row justify-content-center">
                     <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        <div class="d-flex justify-content-center py-4"> <a href="index.html" class="logo d-flex align-items-center w-auto"> <img src="../Assets/img/logo.png" alt=""><span class="d-none d-lg-block">ADMIN LOGIN PORTAL</span> </a></div>
                        <div class="card mb-3">
                           <div class="card-body">
                              <div class="pt-4 pb-2">
                              ...
                              <form class="row g-3 needs-validation" method="POST" name="signin">
                                 ...
                                 <div class="col-12">
                                    <p class="small mb-0">Don't have account? <a href="#">Sign Up Here</a></p>
                                 </div>
                                 <div class="col-12">
                                    <p class="small mb-0">Are You Admin? <a href="../index.php">Click Here</a></p>
                                 </div>
                              </form>
                           </div>
                        </div>
